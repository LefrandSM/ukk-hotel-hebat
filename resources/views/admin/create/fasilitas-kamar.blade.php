...
@section('content')
    ...
    <form method="post" action="/admin/fasilitas-kamar/store">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
            <input type="text" autocomplete="off" name="nama_fasilitas" value="{{ old('nama_fasilitas') }}" class="form-control @error('nama_fasilitas') is-invalid @enderror" id="nama_fasilitas">
