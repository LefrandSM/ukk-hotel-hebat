...
@section('content')
    ...
    <form method="post" action="/admin/kamar/store">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-10">
          <input type="text" autocomplete="off" name="tipe_kamar" class="form-control @error('tipe_kamar') is-invalid @enderror" id="tipe_kamar">
          @error('tipe_kamar')
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
        <input type="number" name="jml_kamar" class="form-control @error('jml_kamar') is-invalid @enderror" id="Jumlah_kamar">
        @error('jml_kamar')
            <p class="text-danger">{{ $message }}</p>
        @enderror
        </div>
